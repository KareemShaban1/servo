		...
		<div class="col-md-12">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					=> __('lang_v1.variable'), 'combo' => __('lang_v1.combo')], null,
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					'form-control select2', 'style' => 'width:100%', 'id' =>
					'product_list_filter_category_id', 'placeholder' =>
					__('lang_v1.all')]); !!}
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					select2', 'style' => 'width:100%', 'id' =>
					'product_list_filter_unit_id', 'placeholder' => __('lang_v1.all')]);
					!!}
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					...
					select2', 'style' => 'width:100%', 'id' =>
					'product_list_filter_tax_id', 'placeholder' => __('lang_v1.all')]);
					!!}
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					...
					select2', 'style' => 'width:100%', 'id' =>
					'product_list_filter_brand_id', 'placeholder' => __('lang_v1.all')]);
					!!}
				</div>
			</div>
			...
			<div class="col-md-3">
				<br>
				<div class="form-group">
					{!! Form::select('active_state', ['active' =>
					__('business.is_active'), 'inactive' => __('lang_v1.inactive')], null,
					['class' => 'form-control select2', 'style' => 'width:100%', 'id' =>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="product_list_tab">
						...
						<a class="btn btn-primary pull-right"
							href="{{action('ProductController@create')}}">
...
$(document).ready(function() {
		...
		createdRow: function(row, data, dataIndex) {
			if ($('input#is_rack_enabled').val() ==
				...
				$(row).find('td:eq(' +
						target_col +
						') div')
					.prepend('<i style="margin:auto;" class="fa fa-plus-circle text-success cursor-pointer no-print rack-details" title="' +
						LANG
						.details +
						'"></i>&nbsp;&nbsp;'
						);
	...
	$(document).on('change', '.product-flag-checkbox', function() {
		var checkbox = $(this);
		var product_id = checkbox.data('product-id');
		var field = checkbox.data('field');
		var value = checkbox.is(':checked') ? 1 : 0;
		var previous_state = !checkbox.is(':checked');
		var was_disabled = checkbox.is(':disabled');

		checkbox.prop('disabled', true);

		$.ajax({
			method: 'POST',
			url: '/products/toggle-flag',
			dataType: 'json',
			data: {
			...
			success: function(result) {
				if (result.success) {
					...
					checkbox.prop('checked', previous_state);
				}
			},
			error: function(xhr) {
