...
return [
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'enable_active_in_app' => 'Active in app',
    'show_in_tab3een' => 'Show in Tab3een',
    'tooltip_show_in_tab3een' => 'If checked, product will appear in the Tab3een app.',
    ...
    'closing_stock_details_report' => 'Closing Stock Details',
    'closing_stock_details_help' => 'Product breakdown using the same calculation as the closing stock totals above.',
    'view_closing_stock_details' => 'View product breakdown',
